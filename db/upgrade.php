...
function xmldb_local_courseheatmappro_upgrade(int $oldversion): bool {
    ...
    if ($oldversion < 2026050407) {
        upgrade_plugin_savepoint(true, 2026050407, 'local', 'courseheatmappro');
    }

    if ($oldversion < 2026050408) {
        upgrade_plugin_savepoint(true, 2026050408, 'local', 'courseheatmappro');
    }

    if ($oldversion < 2026050409) {
        upgrade_plugin_savepoint(true, 2026050409, 'local', 'courseheatmappro');
    }

    if ($oldversion < 2026050410) {
        upgrade_plugin_savepoint(true, 2026050410, 'local', 'courseheatmappro');
    }
